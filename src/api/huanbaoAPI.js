...
export function download () {
  return request({
    url: 'http://plm.longcheer.com/Windchill/netmarkets/jsp/ext/longcheer/common/downloadTest.jsp',
    method: 'post',
    headers: {
      'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
    },
    ...
    data: {
      operation: 'download',
      oid: 'OR:ext.longcheer.envprotection.model.Envprotection:613740428'
    }
  })
}
